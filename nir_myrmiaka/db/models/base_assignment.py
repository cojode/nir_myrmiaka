...
class BaseAssignment(Base):
    ...
    student = relationship('UsersUserprofile', foreign_keys=[student_id], back_populates='base_assignment')
    teacher = relationship('UsersUserprofile', foreign_keys=[teacher_id], back_populates='base_assignment_')
    base_submission = relationship('BaseSubmission', uselist=True, back_populates='assignment')