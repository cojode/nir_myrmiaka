...
async def browse_assignments(
    ...
    work_management_service: WorkManagementService = container.resolve(WorkManagementService)
...
async def accept_assignment(
    ...
    try:
        return await work_management_service.accept_assignment(teacher_id, semestr, assignment_id)
    except ValueError as e:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=str(e))
...
async def accept_assignment(
    ...
    try:
        return await work_management_service.decline_assignment(teacher_id, assignment_id)
    except ValueError as e:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=str(e))